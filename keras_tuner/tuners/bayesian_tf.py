...
class BayesianOptimizationOracleTF(oracle_module.Oracle):
    ...
    def __init__(
        ...
        super(BayesianOptimizationOracleTF, self).__init__(
            objective=objective,
    ...
    def get_state(self):
        state = super(BayesianOptimizationOracleTF, self).get_state()
        state.update(
            {
    ...
    def set_state(self, state):
        super(BayesianOptimizationOracleTF, self).set_state(state)
...
class BayesianOptimizationTF(tuner_module.Tuner):
    ...
    def __init__(
        ...
        **kwargs
        ...
        oracle = BayesianOptimizationOracleTF(
            objective=objective,
            max_trials=max_trials,
